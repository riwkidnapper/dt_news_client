    ...
    return (
      <div>
        ...
        <h3 className="payment">
          {"แพ็กเกจ: 45 บาท 1 เครดิต "}
          <br />
          {"ยอดเงินที่ต้องชำระ : "} {45 * count} {" บาท"}
          <br />
          {"ยอดเงินที่ต้องชำระ : "} {43 * count1} {" บาท"}
          <br />
          {"ยอดเงินที่ต้องชำระ : "} {40 * count2} {" บาท"}
        </h3>
          ...
          >
            ...
            <Form.Row>
              <Form.Group as={Col} md="4" controlId="validationCustom01">
                ...
                <Form.Control as="select">
                  ...
                  <option>
                    ปทุมธานี
                  </option> <option>ประจวบคีรีขันธ์</option>{" "}
            ...
            <Form.Row>
              ...
              >
                {"คำแนะนำเพิ่มเติม "}
                <br />
                {"คุณจะได้รับเครดิตทันทีช่องทางการชำระเงิน"}
                <br />
                {"แบบการโอนผ่านบัญชีธนาคารต้องรอเจ้าหน้าที่"}
                <br />
